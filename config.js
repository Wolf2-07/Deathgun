...
module.exports = {
   ...
   BOT_INFO: process.env.BOT_INFO || "𝐷𝑒𝑎𝑡𝒉𝑠𝑔𝑢𝑛0001;𝐷𝑒𝑎𝑡𝒉𝑠𝑔𝑢𝑛", // YourName;BotName;Image/VideoLink
   SUDO: process.env.SUDO || "242067274660",
   ...
   BRANCH: "master",
   AUTHOR: process.env.AUTHOR || "𝐷𝑒𝑎𝑡𝒉𝑠𝑔𝑢𝑛",
   ANTIWORD: process.env.ANTIWORD || "badword1,badword2,badword3",
   PACKNAME: process.env.PACKNAME || "ᴰᴱᴬᵀᴴˢᴳᵁᴺ",
